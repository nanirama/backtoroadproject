            ...
            <div className="row my-3">
              ...
              <div className="row">
                ...
                <div className="col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-xs-12 d-flex flex-column text-center align-items-center">
                  ...
                  <span>By placing this order you agree to <a href="#" onClick={() => setModalShow1(true)}>Terms and Conditions</a> and <a href="#" onClick={() => setModalShow2(true)}>Privacy Policy.</a></span> </div>
              </div>
            </div>
          </div>
